...
It's my job to build the back end, connect it to the front-end, and then deploy the entire application to Heroku.
...
I will be submitting BOTH of the following for review:
